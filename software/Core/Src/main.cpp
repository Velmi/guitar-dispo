...
uint16_t pData[20] = {2, 4, 5, 6, 7, 8, 9, 9, 0, 324, 2, 4, 5, 6, 7, 8, 9, 9, 0, 324};
/* USER CODE END PV */
...
/* Configure the peripherals common clocks */
  ...
  //HAL_I2S_Transmit(&hi2s6, pData, 20, 20000);
  //HAL_I2S_Transmit_DMA(&hi2s6, txBuffer, sizeof(txBuffer) / sizeof(uint16_t));
